...
export const releaseNotes: ReleaseNote[] = [
  ...
  {
    version: '1.40.0',
    date: moment('2026-06-12').toDate(),
    content: ['c1', 'c2', 'c3', 'c4', 'c6', 'c7'],
  },
  {
    version: '1.38.3',
    date: moment('2026-06-08').toDate(),
  ...
  {
    version: '1.33.0',
    date: moment('2024-09-05').toDate(),
    content: ['c1', 'c2', 'c3'],
  },
  {
    version: '1.32.0',
    date: moment('2024-08-29').toDate(),
    content: ['c1', 'c2', 'c5', 'c6'],
  },
  {
    version: '1.31.0',
    date: moment('2024-08-08').toDate(),
    content: ['c4', 'c2', 'c3', 'c1', 'c5', 'c6', 'c7', 'c8', 'c9', 'c10'],
  },
  {
    version: '1.30.0',
    date: moment('2024-08-02').toDate(),
    content: ['c1', 'c2', 'c3', 'c4', 'c7', 'c8', 'c9', 'c10', 'c11'],
  },
  {
    version: '1.29.1',
