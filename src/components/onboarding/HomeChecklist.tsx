...
/**
 * Canonical checklist item ids. These strings are intentionally stable so
 * Phase 6 (integrator) can coordinate auto-completion signals from other
 * parts of the app.
 */
...
type ChecklistItem = {
   ...
   * itself toggles manual completion separately so users can still mark an
   * item done without leaving the Home screen.
   */
  onPress?: () => void
}
 ...
 * item ids. Intents live in the preferences store under `onboardingIntents`
 * and are read defensively — Phase 3 does not declare the field.
 */
